...
public:
	...
	resource_cursor_type add_value(Message value) {
		resource_cursor_type cur = get_unique_id();
		m_message_resources.insert(std::pair<resource_cursor_type, Message>(cur, value));
	...
	Message& get_message_resource(resource_cursor_type cursor) {
...
private:
	...
	std::map<resource_cursor_type, Message> m_message_resources;
