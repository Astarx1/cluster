...
public:
	ThreadPool(ResourceManager& resource_manager) :
	...
	task_cursor_type add_task(std::string operation_name, 
		resource_cursor_type resource_input, resource_cursor_type resource_output, bool pending=false) {
	...
	void connect_mailbox(Networker * w) {
