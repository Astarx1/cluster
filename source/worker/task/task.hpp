...
class Task {
public:
	Task(std::string operation_name, Resource::resource_cursor_type resource_input, 
		Resource::resource_cursor_type resource_output, std::deque<task_cursor_type> dependencies) :
	...
	Task(std::string operation_name, Resource::resource_cursor_type resource_input, 
		Resource::resource_cursor_type resource_output):
		m_operation(operation_name),
		m_resource_input(resource_input),
		m_resource_output(resource_output) {
		;
	...
	Resource::resource_cursor_type get_input() {
		return m_resource_input;
	}

	Resource::resource_cursor_type get_output() {
...
private:
	...
	Resource::resource_cursor_type m_resource_input;

	TaskStatus m_status;
	Resource::resource_cursor_type m_resource_output;
};
};
#endif